...
const tag = ["cookies", "Singapore", "nature", "cendol"];
...
function getTaggedPhotos(tagName){
    fetch('https://api.tumblr.com/v2/tagged?tag=' + tagName +'&api_key=CvjXuKEax2z9xSkK8WmFb5iDJpxoZwzMJbCZLGizcWBKfxc6FN').then(function(response){
    ...
    .then(function(result){
        ...
        for(let i = 0; i < item.length; i++){
            ...
            if(items.photos !== undefined){
                ...
                const imgSrc = altSizes[altSizes.length - 3].url; //where to link the API to the JS
